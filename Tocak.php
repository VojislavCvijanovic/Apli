 ...
 <html>
	...
	<body class= "front" >
		...
		<div id="card-container">
			     <div class="card">
				 <a href="pocetna.php">
				 <button>	  <img src="Slike/tyre-1.png" alt="tyre1" >
					  <h1 class="name">Fastcar 26" x 1.95" </h1>
					  <p class="price">4.265 RSD</p>
				    ...
				    <div class="card">
					<a href="pocetna.php">
				 <button>	  <img src="Slike/tyre-2.png" alt="tyre2" >
					  <h1 class="name">7Schwalbe Winter Spike Road Tyre</h1>
					  <p class="price">6.835 RSD</p>
					  <p class="name">Lorem Ipsum is simply dummy text of the printing...</p></button> 
					  </a>
				</div>
				    ...
				    <div class="card">
					<a href="pocetna.php">
					 <button > <img src="Slike/wheel-1.png" alt="wheel1" >
					  <h1 class="name">Roue avant R450 700C 32t de</h1>
					  <p class="price">5.945 RSD</p>
					  <p class="name"> Lorem Ipsum is simply dummy text of the printing...</p> </button>
					  </a>
					</div>
